...
inline void py_q_startTranslation(const QString&  port, const QVariant&  params = QVariant()) { this->startTranslation(port, params); }
inline void py_q_stop() { this->stop(); }
inline void py_q_stopEventDevice(const QString&  deviceFile) { this->stopEventDevice(deviceFile); }
inline void py_q_stopTranslation(const QString&  port) { this->stopTranslation(port); }
};
...
void delete_trikControl__BrickInterface(trikControl::BrickInterface* obj) { delete obj; }
   ...
   void startTranslation(trikControl::BrickInterface* theWrappedObject, const QString&  port, const QVariant&  params = QVariant());
   void py_q_startTranslation(trikControl::BrickInterface* theWrappedObject, const QString&  port, const QVariant&  params = QVariant()){  (((PythonQtPublicPromoter_trikControl__BrickInterface*)theWrappedObject)->py_q_startTranslation(port, params));}
   ...
   void stopTranslation(trikControl::BrickInterface* theWrappedObject, const QString&  port);
   void py_q_stopTranslation(trikControl::BrickInterface* theWrappedObject, const QString&  port){  (((PythonQtPublicPromoter_trikControl__BrickInterface*)theWrappedObject)->py_q_stopTranslation(port));}
...
class PythonQtPublicPromoter_trikControl__CameraDeviceInterface : public trikControl::CameraDeviceInterface
{ public:
inline QVector<uint8_t >  py_q_getPhoto() { return this->getPhoto(); }
};
...
void delete_trikControl__CameraDeviceInterface(trikControl::CameraDeviceInterface* obj) { delete obj; }
   QVector<uint8_t >  getPhoto(trikControl::CameraDeviceInterface* theWrappedObject);
   QVector<uint8_t >  py_q_getPhoto(trikControl::CameraDeviceInterface* theWrappedObject){  return (((PythonQtPublicPromoter_trikControl__CameraDeviceInterface*)theWrappedObject)->py_q_getPhoto());}
   QVector<uint8_t >  static_trikControl__CameraDeviceInterface_qImageToQVector(const QImage&  imgOrig);
};
...
inline void py_q_show(const QVector<int32_t >&  array, int  width, int  height, const QString&  format) { this->show(array, width, height, format); }
...
void delete_trikControl__DisplayInterface(trikControl::DisplayInterface* obj) { delete obj; }
   ...
   void show(trikControl::DisplayInterface* theWrappedObject, const QVector<int32_t >&  array, int  width, int  height, const QString&  format);
   void py_q_show(trikControl::DisplayInterface* theWrappedObject, const QVector<int32_t >&  array, int  width, int  height, const QString&  format){  (((PythonQtPublicPromoter_trikControl__DisplayInterface*)theWrappedObject)->py_q_show(array, width, height, format));}
...
inline QVector<uint8_t >  py_q_readRaw() { return this->readRaw(); }
};
...
void delete_trikControl__FifoInterface(trikControl::FifoInterface* obj) { delete obj; }
   ...
   void newData(trikControl::FifoInterface* theWrappedObject, const QVector<uint8_t >&  data);
   ...
   QVector<uint8_t >  readRaw(trikControl::FifoInterface* theWrappedObject);
   QVector<uint8_t >  py_q_readRaw(trikControl::FifoInterface* theWrappedObject){  return (((PythonQtPublicPromoter_trikControl__FifoInterface*)theWrappedObject)->py_q_readRaw());}
...
inline QVector<uint8_t >  py_q_readX(int  reg, int  size) { return this->readX(reg, size); }
...
void delete_trikControl__I2cDeviceInterface(trikControl::I2cDeviceInterface* obj) { delete obj; }
   ...
   QVector<uint8_t >  readX(trikControl::I2cDeviceInterface* theWrappedObject, int  reg, int  size);
   QVector<uint8_t >  py_q_readX(trikControl::I2cDeviceInterface* theWrappedObject, int  reg, int  size){  return (((PythonQtPublicPromoter_trikControl__I2cDeviceInterface*)theWrappedObject)->py_q_readX(reg, size));}
...
{ public:
inline QVector<int32_t >  py_q_getImage() const { return this->getImage(); }
...
void delete_trikControl__IrCameraInterface(trikControl::IrCameraInterface* obj) { delete obj; }
   QVector<int32_t >  getImage(trikControl::IrCameraInterface* theWrappedObject) const;
   QVector<int32_t >  py_q_getImage(trikControl::IrCameraInterface* theWrappedObject) const{  return (((PythonQtPublicPromoter_trikControl__IrCameraInterface*)theWrappedObject)->py_q_getImage());}
