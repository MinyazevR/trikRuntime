...
void PythonQtWrapper_trikControl__BrickInterface::startTranslation(trikControl::BrickInterface* theWrappedObject, const QString&  port, const QVariant&  params)
{
  ( theWrappedObject->startTranslation(port, params));
}
...
void PythonQtWrapper_trikControl__BrickInterface::stopTranslation(trikControl::BrickInterface* theWrappedObject, const QString&  port)
{
  ( theWrappedObject->stopTranslation(port));
}
...
QVector<uint8_t >  PythonQtWrapper_trikControl__CameraDeviceInterface::getPhoto(trikControl::CameraDeviceInterface* theWrappedObject)
{
  return ( theWrappedObject->getPhoto());
}

QVector<uint8_t >  PythonQtWrapper_trikControl__CameraDeviceInterface::static_trikControl__CameraDeviceInterface_qImageToQVector(const QImage&  imgOrig)
{
  return (trikControl::CameraDeviceInterface::qImageToQVector(imgOrig));
}
...
void PythonQtWrapper_trikControl__DisplayInterface::show(trikControl::DisplayInterface* theWrappedObject, const QVector<int32_t >&  array, int  width, int  height, const QString&  format)
{
  ( theWrappedObject->show(array, width, height, format));
}
...
void PythonQtWrapper_trikControl__FifoInterface::newData(trikControl::FifoInterface* theWrappedObject, const QVector<uint8_t >&  data)
{
  ( theWrappedObject->newData(data));
}
...
QVector<uint8_t >  PythonQtWrapper_trikControl__FifoInterface::readRaw(trikControl::FifoInterface* theWrappedObject)
{
  return ( theWrappedObject->readRaw());
}
...
QVector<uint8_t >  PythonQtWrapper_trikControl__I2cDeviceInterface::readX(trikControl::I2cDeviceInterface* theWrappedObject, int  reg, int  size)
{
  return ( theWrappedObject->readX(reg, size));
}
...
QVector<int32_t >  PythonQtWrapper_trikControl__IrCameraInterface::getImage(trikControl::IrCameraInterface* theWrappedObject) const
{
  return ( theWrappedObject->getImage());
}
